...
CREATE TABLE aaa (
  ...
  i09 TINYINT(3),
  i10 TINYINT(4) UNSIGNED,
  i11 TINYINT(4),
  i12 TINYINT(3) UNSIGNED,

  i13 SMALLINT,
  i14 SMALLINT UNSIGNED,
  i15 SMALLINT(5),
  i16 SMALLINT(6) UNSIGNED,
  i17 SMALLINT(6),
  i18 SMALLINT(5) UNSIGNED,

  i19 MEDIUMINT,
  i20 MEDIUMINT UNSIGNED,
  i21 MEDIUMINT(8),
  i22 MEDIUMINT(9) UNSIGNED,
  i23 MEDIUMINT(9),
  i24 MEDIUMINT(8) UNSIGNED,

  i25 BIGINT,
  i26 BIGINT UNSIGNED,
  i27 BIGINT(19),
  i28 BIGINT(20) UNSIGNED,
  i29 BIGINT(20),
  i30 BIGINT(19) UNSIGNED,
